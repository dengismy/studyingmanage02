...
public class student_choose_course_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("score11", map_item.get("score11") + "");
                intent.putExtra("score12", map_item.get("score12") + "");
                intent.putExtra("score21", map_item.get("score21") + "");
                intent.putExtra("score22", map_item.get("score22") + "");
                intent.putExtra("score23", map_item.get("score23") + "");
                intent.putExtra("score31", map_item.get("score31") + "");
                intent.putExtra("score32", map_item.get("score32") + "");
                intent.putExtra("score33", map_item.get("score33") + "");
                intent.putExtra("score34", map_item.get("score34") + "");
                intent.putExtra("score35", map_item.get("score35") + "");
    ...
    public void fenlei_paixu(String order) {
        ...
        while (cursor1.moveToNext()) {
            ...
            map.put("score11", cursor1.getString(cursor1.getColumnIndex("score11")));
            map.put("score12", cursor1.getString(cursor1.getColumnIndex("score12")));
            map.put("score21", cursor1.getString(cursor1.getColumnIndex("score21")));
            map.put("score22", cursor1.getString(cursor1.getColumnIndex("score22")));
            map.put("score23", cursor1.getString(cursor1.getColumnIndex("score23")));
            map.put("score31", cursor1.getString(cursor1.getColumnIndex("score31")));
            map.put("score32", cursor1.getString(cursor1.getColumnIndex("score32")));
            map.put("score33", cursor1.getString(cursor1.getColumnIndex("score33")));
            map.put("score34", cursor1.getString(cursor1.getColumnIndex("score34")));
            map.put("score35", cursor1.getString(cursor1.getColumnIndex("score35")));
