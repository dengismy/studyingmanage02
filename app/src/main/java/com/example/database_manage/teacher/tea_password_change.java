...
public class tea_password_change extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tea_password_change);
    ...
    public void initView()
    {
        ...
        db = new CommonDatabase().getSqliteObject(com.example.database_manage.teacher.tea_password_change.this,"test_db");
    }
    //检验正确性
    public  void  check(String string)
    {
        ...
        {
            Toast.makeText(com.example.database_manage.teacher.tea_password_change.this,"不能为空！",Toast.LENGTH_SHORT).show();
        }
        else
        {
            //去找真正密码
            ...
            {
                Toast.makeText(com.example.database_manage.teacher.tea_password_change.this,"没有找到该账户",Toast.LENGTH_SHORT).show();
            }
            else
            {
                ...
                {
                    Toast.makeText(com.example.database_manage.teacher.tea_password_change.this,"原密码错误！",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    //如果用户前后输入密码不同
                    ...
                    {
                        Toast.makeText(com.example.database_manage.teacher.tea_password_change.this,"前后两次输入与验证密码错误！",Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        ...
                        Toast.makeText(com.example.database_manage.teacher.tea_password_change.this,"修改成功！",Toast.LENGTH_SHORT).show();

                        startActivity(new Intent(com.example.database_manage.teacher.tea_password_change.this, load.class));
                    }
                }
